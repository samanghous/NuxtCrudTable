    ...
    <div>
        ...
        <aside id="default-sidebar"
            ...
            <div class="h-full px-3 py-1 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                ...
                <div class="pt-3 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    RECRUITMENT
                </div>
                <ul class="space-y-2 font-medium">
                    <li>
        ...
        <div class="p-1 sm:ml-64 border-2 border-gray-200 border-dashed dark:border-gray-700">
            <slot />
        </div>
